...
2. **环境变量配置**
   ...
   VITE_SUPABASE_ANON_KEY=<SET_IN_VERCEL_DASHBOARD>

   # 后端 API（如果使用独立后端）
   VITE_API_URL=https://your-backend-api.com

   # 外部 API 配置
   VITE_TDX_CLIENT_ID=<SET_IN_VERCEL_DASHBOARD>
   VITE_TDX_CLIENT_SECRET=<SET_IN_VERCEL_DASHBOARD>
   VITE_CWA_API_KEY=<SET_IN_VERCEL_DASHBOARD>
   VITE_SILICONFLOW_API_KEY=<SET_IN_VERCEL_DASHBOARD>
