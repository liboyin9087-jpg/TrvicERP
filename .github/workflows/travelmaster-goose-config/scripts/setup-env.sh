...
if [ "$all_set" = true ]; then
    ...
    echo "  1. 多角色驗證: .github/workflows/travelmaster-goose-config/scripts/multi-role-ralph-loop.sh"
    echo "  2. 智能修復: .github/workflows/travelmaster-goose-config/scripts/smart-ralph-loop.sh"
else
