...
**使用 Goose + SiliconFlow + DeepSeek V3 進行 UI 元件驗證與自動修正**
...
```bash
export SILICONFLOW_API_KEY="sk-你的-api-key"
...
- [SiliconFlow API 文件](https://docs.siliconflow.cn/)
