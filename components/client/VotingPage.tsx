...
interface Poll { id: string; title: string; description: string; options: { id: string; text: string; votes: number }[]; totalVotes: number; hasVoted: boolean; selectedOption?: string; }
  ...
  return (
    <div className="min-h-screen bg-gray-50 animate-fade-in">
      ...
      <main className="p-6 space-y-6">
        {polls.map((poll) => (
          <div key={poll.id} className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
