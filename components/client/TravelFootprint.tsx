    ...
    <div className="min-h-screen bg-gray-50 animate-fade-in">
      ...
      <div className="bg-white border-b border-gray-100 px-6 py-4">
        <div className="flex justify-around">
          <div className="text-center"><p className="text-2xl font-bold text-gray-900">3</p><p className="text-xs text-gray-500">旅遊國家</p></div>
          <div className="text-center"><p className="text-2xl font-bold text-gray-900">12</p><p className="text-xs text-gray-500">造訪城市</p></div>
          <div className="text-center"><p className="text-2xl font-bold text-gray-900">45</p><p className="text-xs text-gray-500">打卡景點</p></div>
        </div>
      </div>
