...
export default function DigitalBriefing() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 focus:ring-2 focus:ring-primary-300 active:bg-primary-800">
        <Spinner />
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 animate-fade-in focus:ring-2 focus:ring-primary-300 active:bg-primary-800">
      ...
      <main className="p-6 space-y-6">
        {/* Important Notice */}
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 focus:ring-2 focus:ring-primary-300 active:bg-primary-800">
        ...
        <div className="bg-primary-900 text-white p-6 rounded-2xl focus:ring-2 focus:ring-primary-300 active:bg-primary-800">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-gray-400">領隊</p>
            ...
            <div className="flex items-center gap-3">
              <Phone className="w-4 h-4 text-brand-400" />
              <div>
                <p className="text-sm text-gray-400">公司</p>
