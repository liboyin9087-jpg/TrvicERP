  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        ...
        <button disabled={selectedIds.length === 0} className="bg-primary-900 text-white px-5 py-2 rounded-lg font-semibold flex items-center gap-2 hover:bg-gray-800 transition-colors disabled:bg-gray-300 focus:ring-2 focus:ring-primary-300 active:bg-primary-800">
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-100">
              ...
              <th className="text-left px-6 py-4 text-sm font-semibold text-gray-500 uppercase">團次</th>
              <th className="text-left px-6 py-4 text-sm font-semibold text-gray-500 uppercase">日期</th>
              <th className="text-left px-6 py-4 text-sm font-semibold text-gray-500 uppercase">人數</th>
              <th className="text-left px-6 py-4 text-sm font-semibold text-gray-500 uppercase">保險公司</th>
              <th className="text-left px-6 py-4 text-sm font-semibold text-gray-500 uppercase">狀態</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-100">
            {records.map((record) => {
              ...
              return (
                <tr key={record.id} className="hover:bg-gray-50 transition-colors focus:ring-2 focus:ring-primary-300 active:bg-primary-800">
                  ...
                  <td className="px-6 py-4"><span className={`px-3 py-1 rounded-full text-sm font-semibold ${status.bg} ${status.text}`}>{status.label}</span></td>
                </tr>
              );
            })}
          </tbody>
