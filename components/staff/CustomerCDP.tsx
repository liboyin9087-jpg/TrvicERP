...
const CustomerCDP: React.FC = memo(() => {
  ...
  const filteredCustomers = useMemo(() => customers
    ...
    .filter(c => !selectedVip || c.vipLevel === selectedVip), [customers, search, selectedVip]);
  ...
  const handleVipFilter = (vipLevel: string | null) => {
    ...
    >
      <motion.div variants={itemVariants} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">客戶資料平台 (CDP)</h1>
      ...
      <motion.div variants={itemVariants} className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full" aria-label="客戶列表">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200">
                <th scope="col" className="text-left px-6 py-4 text-[11px] font-bold text-slate-500 uppercase tracking-wider">客戶資料</th>
                <th scope="col" className="text-left px-6 py-4 text-[11px] font-bold text-slate-500 uppercase tracking-wider">聯絡方式</th>
                <th scope="col" className="text-left px-6 py-4 text-[11px] font-bold text-slate-500 uppercase tracking-wider">會員等級</th>
                <th scope="col" className="text-left px-6 py-4 text-[11px] font-bold text-slate-500 uppercase tracking-wider">消費概況</th>
                <th scope="col" className="text-left px-6 py-4 text-[11px] font-bold text-slate-500 uppercase tracking-wider">標籤</th>
                <th scope="col" className="text-right px-6 py-4 w-16"></th>
              </tr>
            </thead>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right">
                      <motion.button
                        ...
                        aria-label={`查看${customer.name}詳細資料`}
                      >
        ...
        {filteredCustomers.length === 0 && (
          <div className="py-20 text-center bg-slate-50/50" aria-live="polite">
