                ...
                <Droppable droppableId={column.id}>
                  {(provided, snapshot) => (
                    <div
                      ...
                      className={cn(
                        'flex-1 space-y-3 rounded-lg p-2 transition-colors min-h-[400px]',
                        ...
                        <Draggable key={item.id} draggableId={item.id} index={index}>
                          {(provided, snapshot) => (
                            <div
                              ...
                              className={cn(
                                'bg-white p-4 rounded-lg border border-slate-100 cursor-grab active:cursor-grabbing group transition-all',
